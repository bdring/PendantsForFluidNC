...
extern void show_overrides(override_percent_t feed, override_percent_t rapid, override_percent_t spindle);
extern void show_feedrate_spindle(uint32_t feedrate, uint32_t spindle);
